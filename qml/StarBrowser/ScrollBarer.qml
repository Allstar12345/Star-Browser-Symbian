...
Item {
    id: root
    property bool lightColour: false
    ...
    BorderImage {
        id: track
        objectName: "track"
        source: orientation == Qt.Vertical? "img/ScrollBar/qtg_fr_scrollbar_v_track_normal.svg": "img/ScrollBar/qtg_fr_scrollbar_h_track_normal.svg"
        visible: interactive
        anchors.fill: parent
 ...
 /*   Component {
    ...
    BorderImage {
        id: handle
        objectName: "handle"
        source: lightColour? handleFileNameLight(): handleFileNameDark()
        ...
        function handleFileNameDark() {
            var fileName = orientation == Qt.Vertical ? "img/ScrollBar/qtg_fr_scrollbar_v_handle_" :"img/ScrollBar/qtg_fr_scrollbar_h_handle_"
            if (!interactive)
                fileName += "indicative.svg"
            else if (handleMouseArea.pressed)
               fileName += "pressed.svg"
            else
                fileName += "normal.svg"
            return fileName
        }
        function handleFileNameLight() {
          var fileName = orientation == Qt.Vertical ? "img/ScrollBar/qtg_fr_scrollbar_v_handle_light_" :"img/ScrollBar/qtg_fr_scrollbar_h_handle_light_"
            if (!interactive)
                fileName += "indicative.svg"
            else if (handleMouseArea.pressed)
             fileName += "pressed.svg"
