...
Column {
   ...
   ListItemer {
        ...
        onClicked: {
            ...
            webView.url= "http://mbasic.facebook.com/sharer.php?u="+urls+"&t="+title
            close();
            // root.opacity= 0
         //   killtimer.start()
        }
   ...
   ListItemer {
        ...
        height: 100
        onClicked: {
   webView.url="http://mobile.twitter.com/home?status=Currently reading " + urls
           close();
        }
