...
class QDeclarativeWebView : public QDeclarativeItem {
   ...
   Q_PROPERTY(QString title READ title NOTIFY titleChanged)
    ...
    Q_PROPERTY(QAction* selectAll READ selectAll CONSTANT)
    Q_PROPERTY(QAction* reloadNoCache READ reloadActionNoCache CONSTANT) //EXPERIMENTAL BYPASS CACHE RELOAD
...
public:
    ...
    ~QDeclarativeWebView();
    Q_INVOKABLE void findtxt(const QString bob);
    Q_INVOKABLE void accept(QWebFrame* frame, QWebPage::Feature feature);
    QUrl url() const;
    void setUrl(const QUrl &);
    QString title() const;
    QString httpsState() const;
    ...
    QAction *reloadActionNoCache() const;
    QAction *backAction() const;
    QAction *forwardAction() const;
    QAction *stopAction() const;
    QAction *selectAll () const;
#endif
...
Q_SIGNALS:
    ...
    void urlChanged();
    void audioRequested(QUrl data);
    void videoRequested(QUrl data);
    void imageRequested(QUrl data);
    void progressChanged();
    void statusChanged(Status);
    void dataUsed(quint64 bytes);
    ...
    void jsConsoleMessageRequested();
    void unsupportedcontent();
    void windowCloseRequestedPage();
    void geoLocationRequested();
    void geoLocationPermissionAccepted();
 void geoLocationPermissionDenied();
 void pageBlocked();

 Q_INVOKABLE void downloadRequested(QUrl url, QString fileName);
void javaScriptConsole(const QString &data);
...
private Q_SLOTS:
    ...
    void featurePermRequested(QWebFrame* frame, QWebPage::Feature feature);
