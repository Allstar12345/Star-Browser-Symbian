...
**
** Created: Fri 15. May 22:42:22 2020
...
static const char qt_meta_stringdata_QtDownload[] = {
    "QtDownload\0\0showPopup()\0done()\0"
    "currentStatus\0downloadStatus(float)\0"
    "download()\0data\0downloadFinished(QNetworkReply*)\0"
    "recieved,total\0downloadProgress(qint64,qint64)\0"
    "src,tar\0set(QUrl,QString)\0cancel()\0"
};
...
int QtDownload::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: set((*reinterpret_cast< const QUrl(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 7: cancel(); break;
        default: ;
        }
        _id -= 8;
